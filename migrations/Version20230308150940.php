 ...
 */
final class Version20230308150940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE representation_user (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, representation_id INT DEFAULT NULL, places INT DEFAULT NULL, INDEX IDX_979840A4A76ED395 (user_id), INDEX IDX_979840A446CE82F4 (representation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
